    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.people.update", [$person->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_year') ? 'is-invalid' : '' }}" type="text" name="birth_year" id="birth_year" value="{{ old('birth_year', $person->birth_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eye_color') ? 'is-invalid' : '' }}" type="text" name="eye_color" id="eye_color" value="{{ old('eye_color', $person->eye_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" type="text" name="gender" id="gender" value="{{ old('gender', $person->gender) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hair_color') ? 'is-invalid' : '' }}" type="text" name="hair_color" id="hair_color" value="{{ old('hair_color', $person->hair_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $person->height) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mass') ? 'is-invalid' : '' }}" type="number" name="mass" id="mass" value="{{ old('mass', $person->mass) }}" step="1">
                @if($errors->has('mass'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mass') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('skin_color') ? 'is-invalid' : '' }}" type="text" name="skin_color" id="skin_color" value="{{ old('skin_color', $person->skin_color) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('homeworld') ? 'is-invalid' : '' }}" name="homeworld_id" id="homeworld_id">
                    @foreach($homeworlds as $id => $entry)
                        <option value="{{ $id }}" {{ (old('homeworld_id') ? old('homeworld_id') : $person->homeworld->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $person->url) }}" required>
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
