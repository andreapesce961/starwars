...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.planet.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.planets.update", [$planet->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.planet.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $planet->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diameter') ? 'is-invalid' : '' }}" type="number" name="diameter" id="diameter" value="{{ old('diameter', $planet->diameter) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rotation_period') ? 'is-invalid' : '' }}" type="number" name="rotation_period" id="rotation_period" value="{{ old('rotation_period', $planet->rotation_period) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('orbital_period') ? 'is-invalid' : '' }}" type="number" name="orbital_period" id="orbital_period" value="{{ old('orbital_period', $planet->orbital_period) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gravity') ? 'is-invalid' : '' }}" type="number" name="gravity" id="gravity" value="{{ old('gravity', $planet->gravity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('population') ? 'is-invalid' : '' }}" type="number" name="population" id="population" value="{{ old('population', $planet->population) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('climate') ? 'is-invalid' : '' }}" type="text" name="climate" id="climate" value="{{ old('climate', $planet->climate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('terrain') ? 'is-invalid' : '' }}" type="text" name="terrain" id="terrain" value="{{ old('terrain', $planet->terrain) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surface_water') ? 'is-invalid' : '' }}" type="number" name="surface_water" id="surface_water" value="{{ old('surface_water', $planet->surface_water) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('residents') ? 'is-invalid' : '' }}" name="residents[]" id="residents" multiple>
                    @foreach($residents as $id => $resident)
                        <option value="{{ $id }}" {{ (in_array($id, old('residents', [])) || $planet->residents->contains($id)) ? 'selected' : '' }}>{{ $resident }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $planet->url) }}" required>
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
